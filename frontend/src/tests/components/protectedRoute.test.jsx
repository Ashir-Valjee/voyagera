...
describe('ProtectedRoute', () => {
    ...
    it('should show a loading spinner when authentication is loading', () => {
        authSpy.mockReturnValue({ loading: true, user: null });
    ...
    it('should redirect to the login page if the user is not authenticated', () => {
        authSpy.mockReturnValue({ loading: false, user: null });
    ...
    it('should render the children components if the user is authenticated', () => {
        authSpy.mockReturnValue({ loading: false, user: { email: 'test@example.com' } });
        render(<ProtectedRoute><ProtectedContent /></ProtectedRoute>);
