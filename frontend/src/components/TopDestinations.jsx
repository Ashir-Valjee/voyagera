...
export default function TopDestinations({ isOpen, onClose }) {
    ...
    return (
        <div
            ref={dropdownRef}
            className="absolute mt-2 left-0 bg-white/60 dark:bg-gray-900/70 backdrop-blur-md rounded-lg w-64 p-4 z-50"
        >
            {/* Teal heading */}
            <h2 className="text-md font-semibold mb-3 text-blue-600 italic">
