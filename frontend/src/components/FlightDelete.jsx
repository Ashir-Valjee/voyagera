...
// import { deleteFlightBooking } from "@/services/flightService"; // your service

// const FlightBookingDelete = ({ bookings, onDelete }) => {
//     const [selectedBooking, setSelectedBooking] = useState(null);

//     const handleDelete = async () => {
//         if (!selectedBooking) return;
//         await deleteFlightBooking(selectedBooking.id);
//         if (onDelete) onDelete(selectedBooking.id); // let parent refresh state
...
//                     {booking.departureCity?.city} → {booking.destinationCity?.city}
//                 </h4>
//                 </div>
...
//                     <p><strong>Stops:</strong> {booking.numberOfStops}</p>
...
// export default FlightBookingDelete;
